...
public class LoginController {
    ...
    public String logout1() {
	 ...
	 @GetMapping("/dashboard1") public String dashboard1() { return "dashboard1";
	  }
	 
	  @GetMapping("/profile1") public String profile1() { return "profile1"; }
	 
	 @GetMapping("/settings1") public String settings1() { return "settings1"; }
